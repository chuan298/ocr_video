...
def main():
    ...
    parser.add_argument('--cfg_rec_path', type=str, default="configs/rec/svtrv2/svtrv2_ch.yml",#"configs/rec/svtrv2/svtrv2_smtr_gtc_rctc_infer.yml",#"configs/rec/svtrv2/svtrv2_ch.yml",
    ...
    parser.add_argument('--det_batch_size', type=int, default=2, help='Batch size for detection.')
    parser.add_argument('--rec_batch_size', type=int, default=6, help='Batch size for recognition.')
    parser.add_argument('--type_rec', type=str, default="ch", help='ch or vi')
